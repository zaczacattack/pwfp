...
var cameraTransformActual : Transform;
...
function SetUpRotation (centerPos : Vector3, headPos : Vector3)
{
	...
	//cameraTransformActual.position = cameraTransform.position;// * Quaternion.Euler(0, 10, 0);
	//cameraTransformActual.rotation = cameraTransform.rotation;
	//cameraTransformActual.rotation *= Quaternion.Euler(0, 20, 0);
}
